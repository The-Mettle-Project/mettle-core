 ...
 * The x86-64, ARM64, and PTX paths exist today; SPIR-V is reserved for the
 * dedicated GPU backend added in a later phase.
 */
...
typedef enum {
  ...
  MTLC_ARCH_SPIRV       /* SPIR-V (GPU offload) -- reserved, not yet implemented */
} MtlcArch;
